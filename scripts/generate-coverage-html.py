...
<head>
    ...
    <title>MobileSDK Code Coverage Report</title>
    <style>
        * {{
...
<body>
    <div class="container">
        ...
        <footer>
            <p>MobileSDK iOS • Coverage Report • {commit_info}</p>
        </footer>
    </div>
...
def generate_html_report(coverage_data, output_dir):
    ...
    for target in targets:
        ...
        # Filter to only include our SDK target
        if not any(name in target_name for name in ['MobileSDK', 'Sources']):
            continue
